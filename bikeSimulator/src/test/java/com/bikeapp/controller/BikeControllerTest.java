...
class BikeControllerTest {
	...
	void testGetUserId() throws Exception {
		...
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/publish/bike",bike).content("application/json");
	...
	void testBikeEvent() throws Exception {
		BikeEvent bikeEvent =new BikeEvent();
		ObjectMapper mapper = new ObjectMapper();		
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/publish/bikeevent",bikeEvent).content("application/json");
